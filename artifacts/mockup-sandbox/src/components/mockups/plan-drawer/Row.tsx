  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F7F6F3", minHeight: "100vh", display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "24px 16px" }}>
      ...
      <div style={{ width: 260, display: "flex", flexDirection: "column", gap: 0 }}>
        ...
        {/* Row de plano — clicável, separado */}
        <div style={{ background: "#EFEFEC", borderRadius: 12, padding: "11px 14px", display: "flex", alignItems: "center", gap: 10, cursor: "pointer", marginBottom: 8 }}>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 2 }}>
            <span style={{ fontSize: 10, fontWeight: 600, color: "#AEADA8", textTransform: "uppercase", letterSpacing: 0.8 }}>Plano Gratuito</span>
            <span style={{ fontSize: 13, fontWeight: 600, color: "#1A1A18", letterSpacing: -0.2 }}>100 créditos</span>
          </div>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#AEADA8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <p style={{ marginTop: 20, fontSize: 11, fontWeight: 500, color: "#AEADA8", textAlign: "center", letterSpacing: 0.1 }}>
          Row separado clicável entre os cards
        </p>
      </div>
    </div>
  );
